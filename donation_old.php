...
$productId=$_GET['pid'];
$query = mysql_query("SELECT * FROM soh_products WHERE productId = '$productId'");
?>
<!DOCTYPE html>
<html lang="en">
	<head>
		...
		<div class="content"><div class="ic">More Website Templates @ TemplateMonster.com - March 24, 2014!</div>
			...
			<div class="container_12">
				<div class="grid_4 maxheight">
					<h2><?php echo mysql_result($query,0,'productName'); ?></h2>
					<div class="block1">
				...
				<div class="grid_6 prefix_1 suffix_1 ver maxheight">
					<h2>Child's Details</h2>					
						...
						<p><?php echo mysql_result($query,0,'productName'); ?></p>
						<p>Contribution Amount - <?php echo mysql_result($query,0,'productPrice'); ?></p>
						<p><?php echo mysql_result($query,0,'productDes'); ?></p>
						<form action="order.php" method="post">
						<p>your Details<p>
						<input type="hidden" name="pid" value="<?php echo mysql_result($query,0,'productId'); ?>" >
						
						<input type="input" placeholder="Name" name="name" value="" ><br /> <br />
						<input type="input" placeholder="Mobile No." name="mobile" value="" ><br><br />
						<input type="input" placeholder="Email ID" name="Email" value="" ><br><br />
						Address :<br><textarea name="address">
						</textarea>
						<br />
