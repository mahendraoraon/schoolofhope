			...
			<div class="menu_block">
				...
				<div class="grid_12">
					...
					<form id="form" action="update_event_action.php" method="post" enctype="multipart/form-data">
						...
						<input type="hidden" value="<?php echo htmlspecialchars($EventID); ?>" name="id" id="eventID" />
						<label class="name">
							<input type="text" value="<?php echo htmlspecialchars($EventTitle); ?>" placeholder="Event Title: " name="EventTitle" data-constraints='@Required' required />
							<span class="empty-message">*This field is required.</span>
							<span class="error-message">*This is not a valid name.</span>
						</label>
						<label class="email">
							<input type="text" value="<?php echo htmlspecialchars($EventText); ?>" name="EventText" placeholder="Event Text: " data-constraints='@Required' required />
							<span class="empty-message">*This field is required.</span>
							<span class="error-message">*This is not a valid email.</span>
						</label>
											
						<label class="file">
<a href="../products/<?php echo htmlspecialchars($EventImage); ?>" class="gal"><img src="../products/<?php echo htmlspecialchars($EventImage); ?>" alt=""></a>

						<input type="file" value="<?php echo htmlspecialchars($EventImage); ?>" name="pic" accept="image/*">
						</label>
