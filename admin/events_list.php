...
while ($row = $query->fetch_assoc()) {
			...
			<div class="grid_4">
						<h2>&nbsp;</h2>
						<img src="../products/<?php echo $row['event_image']; ?>" alt="">
					</div>
				<div class="grid_8">
						<h2>Event Title : <?php echo $row['event_title']; ?></h2>
						<p>Event Text : <?php echo $row['event_text']; ?></p>
					<a href="edit_event.php?id=<?php echo $row['id']; ?>" class="btn">Update</a>
					<a href="delete_event.php?id=<?php echo $row['id']; ?>" class="btn">Delete</a>
					</div>
				</div>
				<div class="clear"></div>
				<br />
