...
if($_FILES['pic']['name']==""){
	...
	$result=$mysqli->query("update soh_child set name='$childName',age='$childAge',talent='$childTalent',childClassData='$childClass',description='$descrip' where id='$childID'"); 
