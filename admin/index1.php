			...
			<div class="container_12">
				<div class="grid_12">
					...
					<form id="form" action="update_product.php" method="post" enctype="multipart/form-data">
						...
						<label class="name">
							<input type="text" placeholder="Name:" name="productName" data-constraints='@Required' />
							<span class="empty-message">*This field is required.</span>
							<span class="error-message">*This is not a valid name.</span>
						</label>
						<label class="email">
							<input type="text" name="productPrice" placeholder="Price:" data-constraints='@Required'/>
							<span class="empty-message">*This field is required.</span>
