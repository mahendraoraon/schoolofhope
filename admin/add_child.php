			...
			<div class="menu_block">
				...
				<div class="grid_12">
					...
					<form id="form" action="add_child_action.php" method="post" enctype="multipart/form-data">
						...
						<label class="name">
							<input type="text" placeholder="Name:" name="childName" data-constraints='@Required' required />
							<span class="empty-message">*This field is required.</span>
							<span class="error-message">*This is not a valid name.</span>
						</label>
						<label class="email">
							<input type="text" name="childAge" placeholder="age:" data-constraints='@Required' required />
							<span class="empty-message">*This field is required.</span>
							<span class="error-message">*This is not a valid email.</span>
						</label>
						<label class="email">
							<input type="text" name="childTalent" placeholder="talent:" data-constraints='@Required' required />
							<span class="empty-message">*This field is required.</span>
							<span class="error-message">*This is not a valid email.</span>
						</label>
						<label class="email">
							<input type="text" name="childClass" placeholder="Class:" data-constraints='@Required' required />
							<span class="empty-message">*This field is required.</span>
							<span class="error-message">*This is not a valid email.</span>
						</label>
						...
						<label class="message">
							<textarea placeholder="Description:" name="descrip" data-constraints='@Required @Length(min=20,max=999999)' required ></textarea>
							<span class="empty-message">*This field is required.</span>
