...
<!--==============================Content=================================-->
		<div class="content">
			...
			<div class="menu_block">
				...
				<div class="grid_12">
					<h2>Add New News</h2>
					<form id="form" action="add_news_action.php" method="post" enctype="multipart/form-data">
						<div class="success_wrapper">
							<div class="success-message">Contact form submitted</div>
						</div>
						<label class="name">
							<input type="text" placeholder="Title:" name="news_title" Required />
						</label>
					
						<label class="message">
							<textarea placeholder="Description:" name="news_text" required ></textarea>
