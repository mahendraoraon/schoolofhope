...
<!--==============================Content=================================-->
		<div class="content">
			...
			<div class="menu_block">
				...
				<div class="grid_12">
					<h2>Add Product</h2>
					<form id="form" action="create_product.php" method="post" enctype="multipart/form-data">
						<div class="success_wrapper">
							<div class="success-message">Products submitted</div>
						</div>
						<label class="name">
							<input type="text" id="Pname" placeholder="Name:" name="productName" required />
							<span class="empty-message">*This field is required.</span>
							<span class="error-message">*This is not a valid name.</span>
						</label>
						<label class="email">
							<input type="text" id="Pprice" name="productPrice" placeholder="Price" required />
							<span class="empty-message">*This field is required.</span>
						...
						<label class="file">
						<input type="file" name="pic" id="Pimage" accept="image/*" required>
						</label>
						<label class="message">
							<textarea placeholder="Description:" id="Pdescription" name="descrip" required></textarea>
							<span class="empty-message">*This field is required.</span>
